...
与客户核实ISP的服务条款。在许多商业环境中，ISP会就测试设置特定条款。在发起攻击之前，仔细阅读这些条款。在某些情况下，ISP会拒绝并阻止被视为恶意的流量。客户可能会接受这一风险，但必须在开始前明确沟通。

#### 网络托管

与所有其他第三方一样，需要与网络托管提供商明确沟通测试的范围和时间。此外，在与客户沟通时，确保明确说明测试仅限于寻找网络漏洞，不会涉及底层基础设施的漏洞，这些漏洞可能仍然为应用程序的安全提供隐患。
